...
const Footer = () => {
    return (
        <div className='container mx-auto px-8'>
            <footer className="footer items-center justify-center p-4 rounded-b-full mt-10 mb-5 bg-neutral text-neutral-content">
                <aside className="items-center grid-flow-col">
                    ...
                    <p className='text-base'>Copyright © 2024 - All right reserved || Develop By <Link to='https://www.linkedin.com/in/md-rakibul-islam-19b9b0139/' className='hover:text-red-300'>Md Rakibul Islam</Link></p>
                </aside>
            </footer>
        </div>
    );
